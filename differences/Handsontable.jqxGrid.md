|**/**|Handsontable|jqxGrid|
|-----|------------|-------|
|**Logo**|![Logo](https://raw.githubusercontent.com/handsontable/handsontable/develop/resources/handsontable-logo-blue.svg)|![Logo](http://www.jqwidgets.com/wp-content/design/i/logo-jqwidgets.svg)|
|**Last Editor**|[kirszenbaum](https://github.com/kirszenbaum) (employee)|[vvidolov](https://github.com/vvidolov) (JQWidgets Sales)|
...
|**Description**|JS grid with Excel's look & feel|Advanced Data Grid |
|**License**|[License](https://github.com/handsontable/handsontable/blob/master/LICENSE.txt)|[License](https://www.jqwidgets.com/license/)|
|**Price**|Free/$900+|[Price]( https://www.jqwidgets.com/license/)|
|**Repository**|[Repository](https://github.com/handsontable/handsontable)|[Repository](https://github.com/jqwidgets/jQWidgets)|
|**Stars**|15,832 :star:|266 :star:|
|**Themes**|Excel, Custom|More than 20, including theme builder|
|**Website**|[Website](https://handsontable.com)|[Website](https://www.jqwidgets.com/)|
|**Demo**|[Demo](https://handsontable.com/demo)|[Demo](https://www.jqwidgets.com/jquery-widgets-demo/demos/jqxgrid/index.htm)|
|**-**|||
|**General**|||
...
|**-**|||
|**Rows**|||
|**Floating Rows**|![green](http://placehold.it/23/c5f015/000000?text=+) [:book:](https://handsontable.com/docs/api/options/#fixedrowsbottom)|![red](http://placehold.it/23/f03c15/000000?text=+)|
|**Dynamic Add Rows**|![green](http://placehold.it/23/c5f015/000000?text=+) [:book:](https://handsontable.com/docs/api/options/#allowinsertrow)|![red](http://placehold.it/23/f03c15/000000?text=+)|
|**Dynamic Remove Rows**|![green](http://placehold.it/23/c5f015/000000?text=+) [:book:](https://handsontable.com/docs/api/options/#allowremoverow)|![red](http://placehold.it/23/f03c15/000000?text=+)|
|**-**|||
|**Columns**|||
|**Filters**|Text, Number, Set|Text, Number, Date, Custom|
|**Aggregation**|Average|Sum, Average, Min, Max, First, Last, Custom|
|**Header Rendering**|![green](http://placehold.it/23/c5f015/000000?text=+) [:book:](https://handsontable.com/docs/column-header)|![red](http://placehold.it/23/f03c15/000000?text=+)|
|**-**|||
|**Cells**|||
|**Custom Rendering**|![green](http://placehold.it/23/c5f015/000000?text=+) [:book:](https://handsontable.com/docs/cell-renderer/#registering-custom-cell-renderer)|![red](http://placehold.it/23/f03c15/000000?text=+)|
|**Formula Support**|![green](http://placehold.it/23/c5f015/000000?text=+) [:book:](https://handsontable.com/docs/formula-calculation/#overview)|![red](http://placehold.it/23/f03c15/000000?text=+)|
|**Keyboard Navigation**|Arrows, Enter, Tab, Page, Home, End, UNDO/REDO|Arrows, Enter, Tab, Page, Home|
|**Merge Cells**|![green](http://placehold.it/23/c5f015/000000?text=+) [:book:](https://handsontable.com/docs/merge-cells)|![red](http://placehold.it/23/f03c15/000000?text=+)|
|**-**|||
|**Nice To Have**|||
